      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Manage your CoffeeHub application from here.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <button
              ...
              className="mt-5 bg-amber-800 hover:bg-amber-900 text-white px-5 py-2 rounded-lg font-medium"
            >
              Manage Customers
            </button>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <button
              disabled
              className="mt-5 bg-gray-400 text-white px-5 py-2 rounded-lg font-medium cursor-not-allowed"
            >
              Coming Soon
            </button>
